          ...
          <div className="bg-white/85 backdrop-blur-2xl rounded-3xl p-8 shadow-[0_24px_64px_rgba(0,0,0,0.09),0_4px_16px_rgba(0,0,0,0.05),inset_0_1px_0_rgba(255,255,255,0.9)] border border-white/70 ring-1 ring-indigo-100/50">
            ...
            {submitted ? (
              <div className="text-center space-y-4">
                ...
                <h2 className="text-2xl font-bold text-gray-900">{t('auth.forgotPasswordSentTitle')}</h2>
                <p className="text-gray-500 text-sm">
                  {t('auth.forgotPasswordSentDesc', { email })}
                </p>
                <Link
                  to="/login"
                  className="inline-flex items-center gap-2 text-primary-600 hover:text-primary-700 font-semibold text-sm transition-colors mt-4"
                >
              ...
              <>
                <div className="mb-8">
                  ...
                  <p className="text-gray-500 text-sm mt-1">{t('auth.forgotPasswordSubtitle')}</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="relative">
                      <Mail className="absolute left-3.5 top-1/2 -translate-y-1/2 w-4 h-4 text-primary-400 z-10 pointer-events-none" />
                      <input
                        type="email"
                        value={email}
